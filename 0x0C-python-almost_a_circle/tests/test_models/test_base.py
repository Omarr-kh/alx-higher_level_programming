...
class TestBase_instantiation(unittest.TestCase):
    ...
    def test_dict_id(self):
        self.assertEqual({"t": 15, "t": 22}, Base({"t": 15, "t": 22}).id)

    def test_bool_id(self):
        self.assertEqual(True, Base(True).id)

    def test_list_id(self):
        self.assertEqual([21, 42, 13], Base([21, 42, 13]).id)

    def test_bytes_id(self):
        self.assertEqual(b'testing', Base(b'testing').id)

    def test_bytearray_id(self):
        self.assertEqual(bytearray(b'testing'), Base(bytearray(b'testing')).id)

    def test_memoryview_id(self):
        self.assertEqual(memoryview(b'test'), Base(memoryview(b'test')).id)
    ...
    def test_tuple_id(self):
        self.assertEqual((21, 42), Base((21, 42)).id)

    def test_set_id(self):
        self.assertEqual({21, 12, 13}, Base({21, 12, 13}).id)
...
class TestBase_to_json_string(unittest.TestCase):
    ...
    def test_to_json_string_rect_dicts(self):
